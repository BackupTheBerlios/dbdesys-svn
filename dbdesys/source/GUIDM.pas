...
begin
  ...
  //Copy Settings
  DMMain.CopyDiskFile(SourcePath + DMMain.ProgName + '_Settings.ini',
    DMMain.SettingsPath + DMMain.ProgName + '_Settings.ini', False);
  //Copy Database Info
  DMMain.CopyDiskFile(SourcePath + DMMain.ProgName + '_DatabaseInfo.ini',
    DMMain.SettingsPath + DMMain.ProgName + '_DatabaseInfo.ini', False);
  //Copy Translations Info
  DMMain.CopyDiskFile(SourcePath + DMMain.ProgName + '_Translations.ini',
    DMMain.SettingsPath + DMMain.ProgName + '_Translations.ini', False);

  DMMain.CopyDiskFile(SourcePath + DMMain.ProgName + '_Translations.txt',
    DMMain.SettingsPath + DMMain.ProgName + '_Translations.txt', False);



  //Copy DBConn DefaultSettings
  DMMain.CopyDiskFile(SourcePath + DMMain.ProgName + '_DefaultSettings.ini',
    DMMain.SettingsPath + DMMain.ProgName + '_DefaultSettings.ini', False);
...
begin
  ...
  //if not, copy them
  if (not (FileExists(DMMain.SettingsPath + DMMain.ProgName + '_Settings.ini'))) then
  ...
  begin
    ...
    DMMain.CheckIniFileVersion(DMMain.ProgName + '_Settings.ini', INIVersion_DBDeSys_Settings);
    DMMain.CheckIniFileVersion(DMMain.ProgName + '_DatabaseInfo.ini', INIVersion_DBDeSys_DatabaseInfo);
    ...
    if (not (DMMain.CheckIniFileVersion(DMMain.ProgName + '_Translations.ini', INIVersion_DBDeSys_Translations))) then
      DMMain.CopyDiskFile(ExtractFilepath(Application.ExeName) + 'Data' + PathDelim + DMMain.ProgName + '_Translations.txt',
        DMMain.SettingsPath + DMMain.ProgName + '_Translations.txt', False);
  end;
end;
