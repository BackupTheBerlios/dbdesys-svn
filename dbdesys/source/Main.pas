...
const
  INIVersion_DBDeSys_Settings = 4;
  INIVersion_DBDeSys_DatabaseInfo = 8;
  INIVersion_DBDeSys_Translations = 19;
...
type
  TMainForm = class(TForm)
    ...
    procedure DBDeSysOptionsMIClick(Sender: TObject);
...
begin
  ...
  //Get Version string, defined in DBDeSys.dpr
...
procedure TMainForm.DBDeSysOptionsMIClick(Sender: TObject);
begin
...
begin
  DMMain.BrowsePage('http://dbdesys.humanprofile.biz/');
end;

procedure TMainForm.CheckfornewversionsMIClick(Sender: TObject);
begin
  DMMain.BrowsePage('http://dbdesys.humanprofile.biz/downloads.php');
end;
...
begin
  ...
  begin
    ...
    try
      ...
      if (CompareText(ExtractFilePath(Application.ExeName), '/home/filippo/DBDeSys/') <> 0) then
        theDesktopFile.Text := DMMain.ReplaceText(theDesktopFile.Text,
          '$HOME/DBDeSys/startdbd',
          ExtractFilePath(Application.ExeName) + 'startdbd');

      //Replace Icon Position
      theDesktopFile.Text := DMMain.ReplaceText(theDesktopFile.Text,
        '/home/filippo/DBDeSys/Gfx/Icon48.xpm',
...
begin
  DMMain.BrowsePage('http://dbdesys.humanprofile.biz/support.php');
end;
